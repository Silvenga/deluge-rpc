...
| 14 | `core.remove_torrent`           | `CoreTorrentRpc` | `client.core().torrents.remove_torrent(...)`           | `(torrent_id, remove_data)`                 | `bool`                  | -        | unit |
...
| 27 | `core.get_torrents_status`      | `CoreTorrentRpc` | `client.core().torrents.get_torrents_status(...)`      | `(filter_dict, keys, diff)`                 | `Vec<TorrentEntry>`     | -        | unit |
...
| 47 | `core.get_free_space`           | `CoreSessionRpc`  | `client.core().session.get_free_space(path)`        | `(path)`                          | `i64`                                            | -        | unit |
