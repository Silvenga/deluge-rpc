...
impl StatsClient {
    ...
    pub async fn get_totals(&self) -> Result<StatsTotals, DelugeRpcError> {
        let result = self
            .dispatcher
    ...
    pub async fn get_session_totals(&self) -> Result<StatsTotals, DelugeRpcError> {
        let result = self
            .dispatcher
    ...
    pub async fn set_config(&self, config: &StatsConfig) -> Result<(), DelugeRpcError> {
    ...
    pub async fn get_config(&self) -> Result<StatsConfig, DelugeRpcError> {
        let result = self
            .dispatcher
    ...
    pub async fn get_intervals(&self) -> Result<Vec<i64>, DelugeRpcError> {
        let result = self
            .dispatcher
